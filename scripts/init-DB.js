...
const initDb = async () => {
  ...
  try {
    ...
    await pool.query(`
      CREATE DATABASE ${process.env.PUGDATABASE};
    `);
    ...
    holder_id bigint REFERENCES temp_user (id)
);
    `);
    ...
    user_id bigint REFERENCES temp_user (id),
    ...
    user_id bigint NOT NULL REFERENCES temp_user (id),
    meet_id bigint NOT NULL REFERENCES meet (id),
